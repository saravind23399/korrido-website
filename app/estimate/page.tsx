...
export const metadata: Metadata = { title: 'Pricing', description: 'Build an instant reach-based estimate for your Bengaluru in-cab advertising campaign. No sales call needed.', alternates: { canonical: '/estimate' } };
